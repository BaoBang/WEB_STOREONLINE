...
<html>
<head>
<title>Thể loại: ${category.name} | Admin PTiTShop</title>
		...
		<!-- general form elements disabled -->
          <div class="box box-primary">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Cập nhật thông tin thể loại: <strong>${category.name}</strong></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <div class="form-group${((not empty errors) and (not empty errors.slug)) ? ' has-warning':''}">
                  ...
                  <input type="text" name="category_slug" value="${category.slug}" class="form-control${((not empty errors) and (not empty errors.slug)) ? ' form-control-warning':''}" placeholder="Nhập đường dẫn" required >
                ...
                <div class="form-group${((not empty errors) and (not empty errors.description)) ? ' has-warning':''}">
                  <label>Mô tả</label>
                  <textarea name="category_description" class="form-control${((not empty errors) and (not empty errors.description)) ? ' form-control-warning':''}" rows="3" placeholder="Nhập mô tả" required>${category.description}</textarea>
            ...
            <!-- /.box-body -->
			  <div class="box-footer text-center">
	            <button type="submit" class="btn btn-lg btn-primary"><i class="fa fa-floppy-o"></i> Lưu</button>
	          </div>
           </form>
          </div>
          <!-- /.box -->
