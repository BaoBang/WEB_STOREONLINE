<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
  ...
  <!-- Bootstrap -->
  <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/themes/css/bootstrap.min.css">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="${pageContext.request.contextPath}/themes/font-awesome/css/font-awesome.min.css">
  <!-- carousel CSS -->
  <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/themes/css/owl.carousel.min.css">  
  <!-- Shop CSS -->
